# The Exchange Scratchpad Application layer
...
The Exchange Scratchpad UI planned to be conceptually modular built from universal content panels. Everything in the UI is content panel except menu, tabs and splitters.
